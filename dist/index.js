  ...
  createClass(NoSSR, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          onSSR = _props$onSSR === undefined ? React__default.createElement(DefaultOnSSR, null) : _props$onSSR;
  ...
  function LoadCon() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = LoadCon.__proto__ || Object.getPrototypeOf(LoadCon)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      switch (_this.props.type) {
        default:
        case 'pie':
          return React__default.createElement(Pie, _this.props);
        case 'donut':
          return React__default.createElement(Donut, _this.props);
      }
  ...
  createClass(LoadCon, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        status === 'exception' && React__default.createElement(Exception, null),
        status === 'success' && React__default.createElement(Success, null)
      );
    }
  }]);
  return LoadCon;
